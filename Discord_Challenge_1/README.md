...
> Write script, which checks if entered Polish name is female or male.
> Function must also take into account exception, which is male name 'Kuba'
> If entered name have - more than 13, or less than 3 - letters, program shows message about that incorrect name has been entered.
